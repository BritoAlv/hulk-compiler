...
from lexing.lexer_generator.utils import UnionSets
from lexing.lexer_generator.finite_automata import NFA

def NFAfor_char(char: str):
    return NFA(0, 2, [char], [1], [[[1], []]], additional_info=[[] for _ in range(0, 2)])
...
def ConcatenateNFA(A: NFA, B: NFA):
    ...
    return NFA(start_state, total_states, alphabet, accepting_states, table, [[] for _ in range(0, total_states)])
